        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              "点数がまったく同じだった場合は、先に入力したアーティストから挙がったものを先に並べます。そのため、同じアーティストでも入力の順番を変えると、同点どうしの並び順が入れ替わったり、上位10件の境目にある項目が入れ替わったりすることがあります。",
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              "When two entries score exactly the same, the one coming from the artist you entered earlier is listed first. Entering the same artists in a different order can therefore swap tied entries, or change which entry falls on the boundary of the top 10.",
